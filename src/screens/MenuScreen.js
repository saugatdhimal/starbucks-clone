...
function MenuScreen(menuPage, featuredPage) {
  return (
    < div className="menuScreen">
      <div className="menuScreen__top">
        <Link to="/menu"><p className={menuPage && "menuScreen_p"}>All products</p></Link>
        <Link to="/menu/featured"><p>Featured</p></Link>
        <Link ><p>Previous Orders</p></Link>
        <Link ><p>Favourite Products</p></Link>
      </div>
      <div className="menuScreen__cont">
